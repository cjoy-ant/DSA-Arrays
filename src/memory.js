...
// allocate(size) - reserves a contiguous block of memory consisting of size boxes 
// which you can safely modify, returning a pointer to the 1st box or null if the allocation fails
  allocate(size) {
